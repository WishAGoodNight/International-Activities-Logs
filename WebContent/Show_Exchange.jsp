...
<body>
<s:action name="ExchangeShow" executeResult="true" />
...
<br>
 ...
 <% if(str4.equals(User))out.print("<h4 class=\"alert  alert-info\" ><a href=CreateExchange?ID="+str0+ "&User="+User+">" + "点击这里创建新的活动" +"</a>");%>
		</div>
	</div>
</div>
