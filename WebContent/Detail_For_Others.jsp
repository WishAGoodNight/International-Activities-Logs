...
String Kind=(String)list.get(i);i++;
...
%>
			...
			<div class="jumbotron">
				...
				<p>
					<%out.print(" <a class=\"btn btn-primary btn-large\"  href=OthersEdit?ID="+ID+ ">" +" Edit "+ "</a>");%>
				</p>
...
out.print("<a href=OthersDetail?ID="+str1+">"+str2+"</a></h4>");k++;}
}
j++;
