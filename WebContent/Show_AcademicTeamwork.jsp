...
<body>
<s:action name="AcademicTeamworkShow" executeResult="true" />
...
out.print("<h4 class=\"alert  alert-success animated fadeInDown \"><a href=AcademicTeamworkDetail?Number="+str1+ ">" +"<img style=\"width:20px;height:20px;\" src=\"image/tag.png\" />"+ str2+"-------"+str3+ "</a></h4>");
i++;
if(i<show_list.size())
...
<br>
 ...
 <% if(str4.equals(User))out.print("<h4 class=\"alert  alert-info\" ><a href=CreateAcademicTeamwork?ID="+str0+ "&User="+User+">" + "点击这里创建新的活动" +"</a>");%>
		</div>
	</div>
</div>
