...
%>
			...
			<div class="jumbotron">
				...
				<p>
					<%  if(user.equals(User))
						out.print(" <a class=\"btn btn-primary btn-large\"  href=AcademicTeamworkEdit?Number="+Number+ ">" +" 编辑 "+ "</a>");%>
				</p>
			...
			<div class="jumbotron">
				...
				<p>
					 <%  if(user.equals(User))
						 {
						 out.print(" <a class=\"btn btn-primary btn-large\"  href=AcademicTeamworkEdit?Number="+Number+ ">" +" 编辑 "+ "</a>");
						 out.print(" <a class=\"btn btn-primary btn-large\"  href=Issue?Number="+Number+ "&Sort=2>" +" 发布信息 "+ "</a>");
						 }%>
				</p>
...
out.print("<a href=AcademicTeamworkDetail?Number="+str1+">"+str2+"</a></h4>");
k++;}
}
j++;
