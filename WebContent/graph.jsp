...
$(document).ready(function() {
	...
	chart = new Highcharts.Chart({
		...
		series: [{
			name: '会议情况',
			data: [fa1, fa2, fa3, fa4, fa5, fa6, fa7, fa8, fa9, fa10, fa11, fa12]
		}, {
			name: '研究合作',
			data: [fb1, fb2, fb3, fb4, fb5, fb6, fb7, fb8, fb9, fb10, fb11, fb12]
		}, {
			name: '上课授课',
			data: [fc1, fc2, fc3, fc4, fc5, fc6, fc7, fc8, fc9, fc10, fc11, fc12]
		}, {
			name: '其他事程',
			data: [fd1, fd2, fd3, fd4, fd5, fd6, fd7, fd8, fd9, fd10, fd11, fd12]
		}]
	});
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<h4>
				...
				out.print("<br>本年度共有"+all1+" 个会议项目<br>");
				out.print("本年度共有"+all2+" 个研究合作项目<br>");
				out.print("本年度共有"+all3+" 个上课授课项目<br>");
				out.print("本年度共有"+all4+" 个其他项目<br>");
				%>
			</h4>
			</div>
			</div>
