...
<body>
<form action="ConferenceEditDone">
<div class="container">
...
if(i<list.size()){
str=(String)list.get(i);
out.print("<label>内容</label><textarea name=\"c_Content1\" type=\"text\" class=\"form-control\"  value = \""+str+"\"   rows=\"20\" required/></textarea>");
i++;}
...
i++;
str=(String)list.get(i);
out.print("<label>内容</label><textarea name=\"c_Content2\" type=\"text\" class=\"form-control\"  value = \""+str+"\"  rows=\"20\"/></textarea>");
i++;
str=(String)list.get(i);
out.print("<label>图片</label><input name=\"Image\" type=\"text\" class=\"form-control\"  value = \""+str+"\"  />");
					 %>
				</li>
			</ul>
		</div>
