...
<body>
<s:action name="ConferenceShow" executeResult="true" />
...
<br>
 ...
 <% if(User.equals(str4))out.print("<h4 class=\"alert  alert-info\" ><a href=CreateConference?ID="+str0+ "&User="+User+">" + "点击这里创建新的活动" +"</a>");%>
		</div>
	</div>
</div>
